...
const insertUserActivity = (req: Request, res: Response, next: NextFunction) => {
    const query = `Insert Into User_Activities(Day, User_ID, Activities_ID) Values (CurDate(), ${req.params.userId}, ${req.params.activityId})`;
...
export default {  insertUserActivity, getUserActivity};